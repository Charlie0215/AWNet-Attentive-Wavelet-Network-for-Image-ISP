...
class Generator(nn.Module):
    def __init__(self, in_channels, out_channels, block=[2,3,3,3,5,7], device='cpu'):
        ...
        #upsample3
        self.layer3_up = GCIWTResUp(512, ContextBlock2d, device)
        _layer_3_up = []
        for i in range(block[2]):
        ...
        #upsample2
        self.layer2_up = GCIWTResUp(256, ContextBlock2d, device)
        _layer_2_up = []
        for i in range(block[1]):
        ...
        #upsample1
        self.layer1_up = GCIWTResUp(128, ContextBlock2d, device)
        _layer_1_up = []
        for i in range(block[1]):
