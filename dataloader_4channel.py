        ...
        dslr_image = np.float32(
            np.array(
                Image.fromarray(dslr_image).resize(
                    (dslr_img_shape[0] // self.scale,
                     dslr_img_shape[1] // self.scale)))) / 255.0
